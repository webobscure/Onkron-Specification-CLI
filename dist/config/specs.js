...
const COLOR_TRANSLATIONS = {
  ...
  4: {
    "Черно-белый": "Bianco e nero",
    "Черный": "Nero",
    "Белый": "Bianco",
    "Серый": "Grigio",
    "Серебристый": "Argento",
    "Прозрачный": "Trasparente",
    "Красный": "Rosso",
    "Синий": "Blu",
  },
  5: {
...
const COLOR_TRANSLATIONS_EN = COLOR_TRANSLATIONS[2];
const VESA_OPTION_VALUES = [
  "75x75",
  "100x100",
  "100x200",
  "200x100",
...
const SCREEN_COUNT_OPTION_VALUES = ["1", "2", "3", "4"];
